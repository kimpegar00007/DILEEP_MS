-- ============================================================================
-- DILP MONITORING SYSTEM - PRODUCTION DATA IMPORT (MAY 2026)
-- ============================================================================
-- This script imports production data from May 2026 export
-- Tables: activity_logs, beneficiaries, proponents, proponent_associations,
--         proponent_returns, fieldwork_schedule, system_settings
-- PRESERVES: users table (local accounts remain intact)
-- ============================================================================
...
TRUNCATE TABLE `fieldwork_schedule`;
...
-- Import activity_logs (575 records)
...
-- Import beneficiaries (74 records)
...
-- Import fieldwork_schedule (19 records)
...
-- Import proponent_associations (2 records)
...
-- Import system_settings (1 record)
...
-- ============================================================================
-- STEP 3: RESET AUTO_INCREMENT VALUES TO MATCH PRODUCTION
-- ============================================================================

ALTER TABLE `activity_logs` AUTO_INCREMENT = 576;
ALTER TABLE `beneficiaries` AUTO_INCREMENT = 75;
ALTER TABLE `fieldwork_schedule` AUTO_INCREMENT = 24;
ALTER TABLE `proponents` AUTO_INCREMENT = 3;
ALTER TABLE `proponent_associations` AUTO_INCREMENT = 6;
ALTER TABLE `proponent_returns` AUTO_INCREMENT = 2;
ALTER TABLE `system_settings` AUTO_INCREMENT = 2;

-- ============================================================================
-- STEP 4: RE-ENABLE FOREIGN KEY CHECKS AND COMMIT
-- ============================================================================
